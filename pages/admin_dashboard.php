...
$query = "SELECT COUNT(nome_workshop) 
                            FROM workshops
                            WHERE estado = 'Pendente'";
if (mysqli_stmt_prepare($count, $query)) {


    mysqli_stmt_bind_result($count, $n);
    mysqli_stmt_execute($count);
    mysqli_stmt_fetch($count);
    ...
    <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Número de Users</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Workshops por Validar</div>
                    <div class="row no-gutters align-items-center">
                        <div class="col-auto">
